...
$Scripts = @("Set-SignedPowerShellModules.ps1","New-WDACTrustDB.ps1","Get-WDACEvents.ps1","Resources\Copy-WDACAuditing.ps1","New-WDACGroup.ps1","Register-WDACEvents.ps1","New-WDACPolicy.ps1","Approve-WDACRules.ps1","Import-WDACPolicy.ps1","Merge-TrustedWDACRules.ps1","Edit-WDACPolicy.ps1","Deploy-WDACPolicies.ps1")
