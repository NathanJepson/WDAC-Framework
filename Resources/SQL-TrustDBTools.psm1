...
function New-WDACFilePublisherByCriteria {
    ...
    try {
        ...
        if ($IsBlocking) {
            ...
            if ( (Get-WDACFilePublishers -PublisherIndex $PublisherIndex -FileName $FileName -SpecificFileNameLevel $SpecificFileNameLevel -MinimumAllowedVersion $NewVersionNumber -Connection $Connection -ErrorAction SilentlyContinue).Count -ge 1) {
